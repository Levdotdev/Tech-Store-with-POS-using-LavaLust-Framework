    ...
    <div id="modal-deactivate-staff-confirm" class="modal-overlay hidden">
        ...
        <div class="modal-content">
            <div class="modal-header"><h2>Deactivate Account</h2><button type="button" class="modal-close-btn" onclick="closeModal('modal-delete-confirm')">&times;</button></div>
            ...
            <div class="modal-footer">
                ...
                <button class="action-btn delete-btn" onclick="handleFormSubmit('modal-delete-confirm', 'Applicant deleted.', 'error')">Deactivate</button>
            </div>
        </div>
        </form>
    </div>